...
const CloneSuccessModal: React.FC<CloneSuccessModalProps> = ({ isVisible }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 pointer-events-none">
      <div className="relative bg-gradient-to-br from-slate-800/95 to-slate-900/95 backdrop-blur-xl text-white px-8 py-6 rounded-2xl shadow-2xl border border-slate-700/50 animate-in fade-in-50 slide-in-from-bottom-4 duration-300">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <div className="font-bold text-xl text-white mb-1">Mindmap Cloned!</div>
            <div className="text-slate-400 text-sm">Successfully created a copy of your mindmap</div>
          </div>
        </div>
      </div>
    </div>
