      ...
      >
        ...
        >
          <div className="flex items-center gap-1">
            {hasCollab && (
              <button
                className={`chat-tab px-4 py-2 rounded-xl font-medium text-sm transition-all duration-300 flex items-center gap-2 ${
                  activeTab === "collab"
          ...
          {activeTab === "collab" ? (
                ...
                {collabMessages.map((msg, idx, arr) => {
                  ...
                  return (
                    <div key={idx} className="group">
                      <div className={`flex items-center gap-3 ${showHeader ? 'py-2' : 'py-0.5'} hover:bg-white/5 rounded-xl transition-all duration-200`}>
                        {showHeader && (
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center">
                            ...
                            {!showHeader && (
                              <span className="text-xs text-slate-500 opacity-0 group-hover:opacity-100 transition-opacity duration-200 ml-2">
                                {new Date(msgTime).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}
                              </span>
                            )}
                          </div>
            ...
            <div className="space-y-3">
              {aiMessages.map((msg, idx) => {
                ...
                return (
                  <div key={idx} className="group">
                    <div className="flex items-center gap-3 py-2 hover:bg-white/5 rounded-xl transition-all duration-200">
                      <div
                      ...
                      >
                        {isAI ? <Bot className="w-4 h-4" /> : (msg.user[0] || "U").toUpperCase()}
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
        ...
        >
          ...
          <button
            type="submit"
            className={`px-6 py-3 rounded-2xl font-medium transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 ${
              activeTab === "collab"
