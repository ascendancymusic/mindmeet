...
export const MindMapMindNode = React.memo(({ data, id }: NodeProps) => {
  ...
  return (
    <div className="relative group hover:z-10">
       ...
       <RouterLink
         to={targetPath}
         className="relative flex items-center gap-2.5 bg-[#1e293b] border border-slate-700/50 group-hover:border-purple-500/30 rounded-2xl p-2.5 min-w-[160px] max-w-[220px] shadow-lg hover:bg-[#1e293b] no-underline"
