...
export const FolderMindNode = React.memo(({ data }: NodeProps) => {
  return (
    <div className="relative group">
      ...
      <div 
        className="absolute -inset-0.5 rounded-2xl opacity-20 group-hover:opacity-40"
        style={{ background: data.color || '#3b82f6' }}
      ></div>
      
      {/* Removed backdrop-blur-xl which can be performance heavy during drag */}
      <div className="relative flex items-center gap-3 bg-[#0f172a] border border-slate-700/50 rounded-2xl p-3 min-w-[180px] max-w-[260px] shadow-xl">
